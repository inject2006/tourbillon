...
class NanJingYL(OTABase):
    """
    南京易旅
    aes密钥 C5OF3YKENMDD37YH
    访问token z0rml92ifpebakwv
    访问name nanjingyl

    """
    ticket_process_mode = 'api'  # 票号处理模式-接口方式
    order_detail_process_mode = 'api'  # 订单详情同步模式-接口模式
    ota_name = 'nanjingyl'  # OTA名称，保证唯一，必须赋值
    ota_env = 'PROD'  # 生产OR测试接口 TODO 暂时无作用
    ota_token = 'z0rml92ifpebakwv'  # ota 访问验证token
    pay_channel = 'ALIPAY'
    cn_ota_name = '南京易旅'
